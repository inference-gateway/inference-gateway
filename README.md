...
| `POST /v1/audio/speech`       | [OpenAI Audio Speech API](https://platform.openai.com/docs/api-reference/audio/createSpeech) - generate speech audio from text, returns the streamed binary audio (OpenAI provider only)                                         |
