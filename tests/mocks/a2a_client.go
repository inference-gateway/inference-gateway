...
//
//	mockgen -source=client.go -destination=../tests/mocks/a2a_client.go -package=mocks
//
...
// ConvertA2ASkillsToChatCompletionTools mocks base method.
func (m *MockA2AClientInterface) ConvertA2ASkillsToChatCompletionTools(skills []a2a.AgentSkill) []providers.ChatCompletionTool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ConvertA2ASkillsToChatCompletionTools", skills)
	ret0, _ := ret[0].([]providers.ChatCompletionTool)
	return ret0
}

// ConvertA2ASkillsToChatCompletionTools indicates an expected call of ConvertA2ASkillsToChatCompletionTools.
func (mr *MockA2AClientInterfaceMockRecorder) ConvertA2ASkillsToChatCompletionTools(skills any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ConvertA2ASkillsToChatCompletionTools", reflect.TypeOf((*MockA2AClientInterface)(nil).ConvertA2ASkillsToChatCompletionTools), skills)
}
...
func (m *MockA2AClientInterface) GetAllChatCompletionTools() []providers.ChatCompletionTool {
	m.ctrl.T.Helper()
...
func (mr *MockA2AClientInterfaceMockRecorder) GetAllChatCompletionTools() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllChatCompletionTools", reflect.TypeOf((*MockA2AClientInterface)(nil).GetAllChatCompletionTools))
}
