	...
	tests := []struct {
	...
	}{
		{
			...
			expectedCfg: config.Config{
				...
				ExposeMcp:                false,
				McpServers:               "",
				McpClientTimeout:         5 * time.Second,
				McpDialTimeout:           3 * time.Second,
				McpTlsHandshakeTimeout:   3 * time.Second,
				McpResponseHeaderTimeout: 3 * time.Second,
				McpExpectContinueTimeout: 1 * time.Second,
